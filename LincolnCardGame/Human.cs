        ...
        public override Tuple<Card, Card> Play2Cards()
        {
            ...
            while (true)
            {
                try
                {
                    ...
                    Card chosenCard1 = PlayerHand.AHand[Convert.ToInt32(Console.ReadLine()) - 1];
                    ...
                    Card chosenCard2 = PlayerHand.AHand[Convert.ToInt32(Console.ReadLine()) - 1];

                    // Check user haven't chosen the same card twice
                    if (chosenCard1.Equals(chosenCard2))
                    {
                        Console.Clear();
